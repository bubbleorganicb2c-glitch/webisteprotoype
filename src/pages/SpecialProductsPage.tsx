...
function SpecialProductsPage() {
  ...
  const specialProducts = PRODUCTS.filter(p => p.category === 'Bubble Organic Special Products');
    ...
    <div className="min-h-screen relative">
      ...
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold text-green-800 mb-8">Bubble Organic Special Products</h1>

          {specialProducts.length === 0 ? (
            <div className="text-center py-16 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg">
              <p className="text-gray-500 text-xl">No special products available at the moment</p>
              <p className="text-sm text-gray-400 mt-2">Check back soon for our special organic collection!</p>
              <Link
                to="/#products"
